import{h as _,j as d,k as p,al as u,c as m,am as h,m as n,an as t,ao as s,A as o,F as f,ap as v,aq as g,ar as x,s as r,as as y,at as b,q as k,au as N,av as P,_ as w}from"./nav-31143400.js";import{N as S}from"./NoteDisplay-788bdca6.js";import{u as V}from"./index-2cd034e2.js";import"./_commonjsHelpers-725317a4.js";const j={class:"m-4"},C={class:"mb-10"},D={class:"text-4xl font-bold mt-2"},L={class:"opacity-50"},T={class:"text-lg"},B={class:"font-bold flex gap-2"},H={class:"opacity-50"},q=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-gray-400/50 mb-8"},A=_({__name:"PresenterPrint",setup(F){d(p),u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
